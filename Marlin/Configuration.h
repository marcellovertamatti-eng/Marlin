...
#define CUSTOM_MACHINE_NAME "CR-10 V2 - SKR Mini E3 V3"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 415 } // E0: placeholder p/ Direct Drive - CONFIRME o valor certo do seu extrusor (M92)
